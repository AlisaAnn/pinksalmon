...
#read in all length weight data for known origin fish from 2021-2023
pink.k <- read_csv("data/Pink_K.csv")
head(pink.k)
tail(pink.k)
#pink.k <- filter(pink.k, !is.na(Length))
#above line was to remove NA rows of NA
...
# Read in the data (2021 - 2025) and rename any columns that need renaming
...
distinct(pinkLW,Year) #years 2021 - 2025 
distinct(pinkLW,Month) #there is no Month column
